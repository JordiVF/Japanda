...
function Nav() {
    ...
    // Autocambio de banner cada 10 segundos, falta anyadir mas fotos si eso
    useEffect(() => {
    ...
    // Para cambiar banner manualmente
    ...
    return (
        <>
            ...
            <div className="navbar-wrapper">
                <img src={logo} alt="Logo Japanda" className='logo-navbar' onClick={link} />

                <div className="nav-searchbar">
                    <svg xmlns="http://www.w3.org/2000/svg" className='search-svg' viewBox="0 0 24 24" fill="none">
                        <path d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <input type="text" className='input-buscador' placeholder='Buscar producto...' />
                </div>
                <nav className="navbar">
                    ...
                    <div className='navbar-svg-element-wrapper'>
                        ...
                        <div className='side-container'>
                            <a href='#' className='navbar-element'><span className="nav-text" onClick={() => setIsCartOpen(true)}>Carrito</span>
                                {totalItems > 0 && (
                                    <span className="nav-cart-count" onClick={() => setIsCartOpen(true)} >{totalItems} </span>
                                )}
                            </a>
