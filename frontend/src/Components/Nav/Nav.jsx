                    ...
                    <div className="navbar-svg-element-wrapper">
                        ...
                        <div className="side-container">
                            <a href="#" className="navbar-element">
                                <span className="nav-text" onClick={() => setIsCartOpen(true)}>
                                    Carrito
                                </span>
                                {totalItems > 0 && (
                                    <span className="nav-cart-count" onClick={() => setIsCartOpen(true)}>
                                        {totalItems}
                                    </span>
                                )}
                            </a>
                        ...
                        >
                            {banners.map((banner, index) => (
                                <div className="banner-slide" key={index}>
                                    <img src={banner} alt={`Banner ${index + 1}`} className="banner-ad" />
                                </div>
                            ))}
                        </div>
                    </div>
